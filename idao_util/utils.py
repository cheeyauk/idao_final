...
SIMPLE_FEATURE_COLUMNS_2 = ['ncl[0]', 'ncl[1]', 'ncl[2]', 'ncl[3]', 'avg_cs[0]',
       'avg_cs[1]', 'avg_cs[2]', 'avg_cs[3]', 'ndof', 'MatchedHit_TYPE[0]',
       'MatchedHit_TYPE[1]', 'MatchedHit_TYPE[2]', 'MatchedHit_TYPE[3]',
       'MatchedHit_X[0]', 'MatchedHit_X[1]', 'MatchedHit_X[2]',
       'MatchedHit_X[3]', 'MatchedHit_Y[0]', 'MatchedHit_Y[1]',
       ...
       'MatchedHit_T[0]', 'MatchedHit_T[1]', 'MatchedHit_T[2]',
       'MatchedHit_T[3]', 'MatchedHit_DT[0]', 'MatchedHit_DT[1]',
       'MatchedHit_DT[2]', 'MatchedHit_DT[3]',  'NShared', 'FOI_hits_N', 'PT', 'P']
...
def find_closest_hit_per_station(row):
    result = np.empty(N_FOI_FEATURES+1, dtype=np.float32)
    ...
    t_sum = 0 if np.isnan(np.nansum(closest_T_per_station)) else np.nansum(closest_T_per_station)  
    return result
